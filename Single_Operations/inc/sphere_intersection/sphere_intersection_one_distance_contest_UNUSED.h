...
// #ifdef GPU
//     __global__ void sphere_intersection_one_distance_contest_Kernel(u64 array_size, Ray* dev_rays, Sphere* dev_spheres, Hit_info* dev_output_hit_infos)
//     {
...
// class sphere_intersection_one_distance_contest : public sphere_intersection_BASE
// {
//     #ifdef CPU
//         void cpu_task(int i)
//         {
...
//         void cuda_launch()
//         {
//             sphere_intersection_one_distance_contest_Kernel<<<NUMBER_OF_BLOCKS, BLOCK_SIZE>>>(ARRAY_SIZE, dev_rays, dev_spheres, dev_output_hit_infos);
//             CCE(cudaDeviceSynchronize());
//         }
//     #endif

// public:
//     sphere_intersection_one_distance_contest(string name, u64 s)
